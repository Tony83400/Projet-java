...
public class MenuController {
    ...
    @OpenApi(summary = "Récupérer tous les catégories", operationId = "getAllMenu", path = "/menu", methods = HttpMethod.GET, tags = {
            "Menus" }, responses = {
    ...
    @OpenApi(summary = "Trouve un menu par id", operationId = "getMenuById", path = "/menu/{id}", methods = HttpMethod.GET, tags = {
            "Menus" }, pathParams = {
            @OpenApiParam(name = "id", type = Integer.class, description = "ID du menu", required = true)
    }, responses = {
            @OpenApiResponse(status = "201", description = "Menu trouvé"),
